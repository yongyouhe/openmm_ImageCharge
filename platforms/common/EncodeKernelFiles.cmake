...
SET(KERNEL_FILE_DECLARATIONS) #设置变量为空
...
FOREACH(file ${KERNEL_FILES})
    ...
    # Determine a name for the variable that will contain this file's contents. 获取去掉.cc后的文件名
    #计算从${KERNEL_SOURCE_DIR}/kernels到${file}的相对路径，并将其存储在filename中
